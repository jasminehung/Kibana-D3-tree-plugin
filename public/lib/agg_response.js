//takes data from Elasticsearch and transfer into a JSON structure (flare) 
define(function (require) {
  return function TreeProvider(Private, Notifier) {
    var _ = require('lodash');
    var arrayToLinkedList = require('ui/agg_response/hierarchical/_array_to_linked_list');
    var notify = new Notifier({
      location: 'Tree chart response converter'
    });
